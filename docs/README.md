# Working-group handoff documents

These files are copies of draft-plan and migration planning documents from the release planner working group. They are staged here as an **interim home** while the long-term GitHub home (`opendatahub-io/rhai-release-planner`) is set up.
...
Do not commit secrets, large model pickles, or Org Pulse application code here.
